                    ...
                    <List>
                        {
                            shops.map( (shop, index) => {
                                return (
                                    <TouchableHighlight key={shop.shopId} onPress={handlePress(index)}
                                        activeOpacity={0.3} underlayColor='#ddddd'
                                    >
                                        <ListItem>
                                            <Left>
                                                <View>
                                                ...
                                                <View style={styles.details}>
                                                    ...
                                                    <AirbnbRating defaultRating={shop.rating} size={14} showRating={false} 
                                                        isDisabled={true}
                                                    />
                                                </View>
                                            </Left>
