    ...
    return (
        <View style={styles.root}>
                            ...
                            <ScrollView>
                                {
                                    shop.services.map( (service, index) => {
                                        return (
                                            <TouchableHighlight onPress={handlePress(index)} activeOpacity={0.5} 
                                                underlayColor="rgba(0,0,0,0.1)" key={index}
                                            >
                                ...
                                }
                                {
                                    shop.services.map( (service, index) => {
                                        return (
                                            <TouchableHighlight onPress={handlePress(shop.services.length + index)} activeOpacity={0.5} 
                                                underlayColor="rgba(0,0,0,0.1)" key={index}
                                            >
                                                <ListItem style={styles.item}>
                                                    <Text>
            ...
            <View>
                {
                    show && (
                        <DateTimePicker testId="dateTimePicker" value={date} mode={mode} is24Hour={false} 
