...
//native base
import { CardItem, Card, Badge, Button } from 'native-base';
        ...
        <Card style={{position: 'relative'}}>
            ...
            <CardItem cardBody>
                <View style={{marginLeft: 10}}>
                    ...
                    <View>
                        <AirbnbRating size={15} showRating={false} count={5}
                            isDisabled={true} style={styles.rating} defaultRating={shop.rating}
                        />
                    </View>
                </View>
            </CardItem>
